    ...
    locales: {
      ...
      fr: {
        ...
        content: [
          ...
          "L'injection de prompt n'a pas d'équivalent. Il n'existe pas de prompt paramétré. Vous ne pouvez pas remettre au modèle une structure disant « ceci est une instruction, ceci est une donnée, ne les confonds jamais », parce que le modèle prédit le token suivant sur une seule séquence plate. Les délimiteurs aident un peu et se contournent trivialement avec un texte qui contient le délimiteur. Le terme a été nommé par Simon Willison en septembre 2022, après que Riley Goodside a démontré l'attaque, et quatre ans plus tard il n'existe toujours pas de défense complète — non faute d'avoir essayé, mais parce que ce qui la corrigerait est une séparation que l'architecture n'a pas.",
