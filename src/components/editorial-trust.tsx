  ...
  return (
    <section className="glass rounded-2xl p-5">
      ...
      <ul className={`mt-3 text-sm text-[color:var(--text)] ${compact ? "space-y-1.5" : "space-y-2"}`}>
        <li>1. {fr ? "Mises a jour hebdomadaires IA + CS." : "Weekly AI + CS updates."}</li>
        <li>2. {fr ? "Sources explicites et references visibles." : "Explicit sources and visible references."}</li>
        <li>3. {fr ? "Recommandations orientees execution et budget etudiant." : "Execution-first recommendations within student budgets."}</li>
      </ul>
