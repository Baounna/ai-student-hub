# Perplexity trusts GPT-6 Astra with end-to-end systems: What It Means for AI/CS Students
...
- Opportunity slug: 20260914-perplexity-trusts-gpt-6-astra-with-end-to-end-systems-12e9dd68
- Source: OpenAI News
- Source URL: https://openai.com/index/perplexity-improving-accuracy-with-astra
- Topic: AI Systems
...
## Introduction draft
Perplexity trusts GPT-6 Astra with end-to-end systems is one of the most relevant recent updates for students building AI and computer science projects.  
...
## Source references
1. OpenAI News: https://openai.com/index/perplexity-improving-accuracy-with-astra
